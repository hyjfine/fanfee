...
import 'package:flutter_app_eat/todo_list_page/datetime_util.dart';
            ...
            onPressed: () {
              ...
              Firestore.instance
                  ...
                  .document(DateTimeUtil.dateTimeNormal(
                      _fromDateTime.toIso8601String()))
                  .setData({'name': _eventName, "fee": double.parse(_fee)});
